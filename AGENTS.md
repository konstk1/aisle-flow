...
- When asked to work on a GitHub issue, name the branch `<issue-number>-<short-name>` (for example, `8-product-route`). If the current branch is not that branch, check out `main`, pull it, then create the issue branch from `main`.
